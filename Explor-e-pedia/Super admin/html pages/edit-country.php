...
<head>
	...
	<!-- Title-->
	<title>Edit Country | Explor-e-pedia</title>
    ...
    <section id="add-country" class="admin-add-page">
        ...
        <div class="general-box">
            <div class="content-box-lg">
                ...
                <div class="container">
                    <div class="row">
                        <p class="section-heading">Edit Country</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <form action="Edit/edit-country-process" method="POST">
                           <?php
                                    $id=$_GET['id'];
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-box-style" name="countryname" id="countryname"
                                            aria-describedby="countryname" placeholder="Enter country name" value="<?php echo $row['country_name'];?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-box-style" name="countrycode" id="countrycode"
                                            aria-describedby="countrycode" placeholder="Enter country code" value="<?php echo $row['country_code'];?>">
                                    </div>
