...
<head>
	...
	<!-- Title-->
	<title>Manage Category | Explor-e-pedia</title>
...
<body>
    ...
    ?>  
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-12">
                        <button onclick="window.location.href='add-category'" class="btn btn-general btn-purple add-category-btn">Add Category</button>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="edit-category?id=<?php echo $row['id'];?>">
                                            <img class="edit-img-in-table" src="../images/Dashboard/edit.png" alt="edit">
                                        </a>
                                        <a href="Delete/category?id=<?php echo $row['id'];?>">
        ...
        // Number of pages required.   
               ...
               if($page>=2){   
                echo "<li class='page-item'><a class='page-link' aria-label='Previous' href='manage-category.php?page=".($page-1)."'>  <img src='../images/pagination/left-arrow.png' alt='previous'> </a></li>";   
            }       

            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<li class='page-item'><a class = 'active page-link' href='manage-category.php?page="  
                  .$i."'>".$i." </a></li>";   
              }               
              else  {   
                  $pagLink .= "<li class='page-item'><a class='page-link' href='manage-category.php?page=".$i."'>   
                  ".$i." </a></li>";     
              }   
          };     
          echo $pagLink;   
          ...
          if($page<$total_pages){   
            echo "<li class='page-item'><a class='page-link' aria-label='Next' href='manage-category.php?page=".($page+1)."'>  <img style='color: white;' src='../images/pagination/right-arrow.png' alt='next'> </a></li>";   
        }   
