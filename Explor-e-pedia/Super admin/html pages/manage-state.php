...
<head>
	...
	<!-- Title-->
	<title>Manage State | Explor-e-pedia</title>
...
<body>
    <section id="manage-type" class="admin-manage-page">
        ...
        $query = "SELECT * FROM state LIMIT $start_from, $per_page_record";     
    ...
    ?>  
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-left box-heading-wrapper">
                        <p class="box-heading">Manage State</p>
                    </div>

                    <div class="col-lg-5 col-md-5 col-sm-5 col-12">
                        <button onclick="window.location.href='add-state'" class="btn btn-general btn-purple add-type-btn">Add State</button>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                    ...
                                    if(mysqli_num_rows($rs)>0)
                                        {
                                            while($row=mysqli_fetch_assoc($rs))
                                                {
                                                    $qry1="SELECT * FROM country where isactive=1 and id='".$row['country_id']."'";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="edit-state?id=<?php echo $row['id'];?>">
                                            <img class="edit-img-in-table" src="../images/Dashboard/edit.png" alt="edit">
                                        </a>
                                        <a href="Delete/state?id=<?php echo $row['id'];?>">
        ...
        // Number of pages required.   
               ...
               if($page>=2){   
                echo "<li class='page-item'><a class='page-link' aria-label='Previous' href='manage-state.php?page=".($page-1)."'>  <img src='../images/pagination/left-arrow.png' alt='previous'> </a></li>";   
            }       

            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<li class='page-item'><a class = 'active page-link' href='manage-state.php?page="  
                  .$i."'>".$i." </a></li>";   
              }               
              else  {   
                  $pagLink .= "<li class='page-item'><a class='page-link' href='manage-state.php?page=".$i."'>   
                  ".$i." </a></li>";     
              }   
          };     
          echo $pagLink;   
          ...
          if($page<$total_pages){   
            echo "<li class='page-item'><a class='page-link' aria-label='Next' href='manage-state.php?page=".($page+1)."'>  <img style='color: white;' src='../images/pagination/right-arrow.png' alt='next'> </a></li>";   
        }   
