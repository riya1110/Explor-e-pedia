...
<head>
	...
	<!-- Title-->
	<title>Edit State | Explor-e-pedia</title>
    ...
    <section id="add-country" class="admin-add-page">
        ...
        <div class="general-box">
            <div class="content-box-lg">
                ...
                <div class="container">
                    <div class="row">
                        <p class="section-heading">Edit State</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <form action="Edit/edit-state-process" method="POST">
                            <?php
                                    $id=$_GET['id'];
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-box-style" name="statename" id="statename"
                                            aria-describedby="countryname" placeholder="Enter state name" value="<?php echo $row['state_name'];?>">
                                    </div>
                                            ...
                                            <?php 
                                             ...
                                             $rs1=mysqli_query($conn,$qry1);
                                                ...
                                                if(mysqli_num_rows($rs1)>0)
                                                {
                                                    ...
                                                    {
                                            ?>
                                            <option value="<?php echo $row1['id'];?>"><?php echo $row1['country_name']?></option>
                                            <?php
                                                    }
                                                }
                                            ?>
