...
<head>
	...
	<!-- Title-->
	<title>Manage Place-Owner | Explor-e-pedia</title>
...
<body>
    <section id="manage-administrator" class="admin-manage-page">
        ...
        $query = "SELECT * FROM user where Role_id=2 LIMIT $start_from, $per_page_record";     
    ...
    ?>  
            ...
            <div class="container">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-left box-heading-wrapper">
                        <p class="box-heading">Manage Place Owner</p>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Place Owner Id</th>
                            ...
                            <tbody>
                                <?php
                                   // $qry="SELECT * FROM user where Role_id=2";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="Delete/placeowner?id=<?php echo $row['Id'];?>">
        ...
        <!-- manage-administrator table ends -->

         <!-- pagination -->
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
               <?php  
               $query = "SELECT COUNT(*) FROM user where Role_id=2";     
        ...
        // Number of pages required.   
               ...
               if($page>=2){   
                echo "<li class='page-item'><a class='page-link' aria-label='Previous' href='manage-placeowner.php?page=".($page-1)."'>  <img src='../images/pagination/left-arrow.png' alt='previous'> </a></li>";   
            }       

            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<li class='page-item'><a class = 'active page-link' href='manage-placeowner.php?page="  
                  .$i."'>".$i." </a></li>";   
              }               
              else  {   
                  $pagLink .= "<li class='page-item'><a class='page-link' href='manage-placeowner.php?page=".$i."'>   
                  ".$i." </a></li>";     
              }   
          };     
          echo $pagLink;   
          ...
          if($page<$total_pages){   
            echo "<li class='page-item'><a class='page-link' aria-label='Next' href='manage-placeowner.php?page=".($page+1)."'>  <img style='color: white;' src='../images/pagination/right-arrow.png' alt='next'> </a></li>";   
        }   
