...
<head>
	...
	<!-- Title -->
	<title>FAQ | Explor-e-pedia</title>
...
<body>
	...
	<section id="faq">
						...
						<div class="accordion faq2" id="accordionExample">
							<div class="card">
								<div class="card-header" id="headingOne">
									...
									<p>Where did Notes Marketplace start?</p>
								...
								<div id="faq-2" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
									...
									<div class="card-body">
										What started out as four friends chucking around an idea in Ahmedabad ended up turning into an earliest version of Notes Marketplace. So, with 2021 batch of tatvasoft – we has developed this product.
									</div>
		...
		<!-- Uploaders General-box ends-->

		<!--Downloaders general-box -->
		<div class="general-box">
			<div class="content-box-lg">
