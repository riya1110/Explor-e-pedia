...
<body>
	...
	<section id="user-profile">
		...
		<div class="small-height-bg">
			<p class="text-center">Welcome Placeowner <?php echo $_SESSION['name']; ?></p>
		</div>
		<!-- background -->
		...
		<div class="general-box">
			...
			<form action="placeowner-profile-process" method="POST" enctype="multipart/form-data">
		...
		<!--Basic Profile details container ends-->


		<!-- Address details conatiner -->
		<div class="general-box">
			<div class="content-box-lg">
		...
		<!--Address details container ends-->
