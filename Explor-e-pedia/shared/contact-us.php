					...
					<div class="header-wrapper">
						...
						<div class="navigation-wrapper">
							<nav class="main-nav">
								<ul class="menu-navigation">
									<li>
										<a href="index-search-places">Search Places</a>
									</li>
									<li>
										<a href="faq">FAQ</a>
									</li>
									...
									<li>
										<a class="btn btn-general btn-purple" href="login" title="Download" role="button">Login</a>
									</li>
								</ul>
							</nav>
						</div>
						...
						<div id="mobile-nav">
							...
							<div id="mobile-nav-content">
								<ul class="nav">
									<li>
										<a href="search-places">Search Places</a>
									</li>
									<li>
										<a href="faq">FAQ</a>
									</li>
