	...
	<div class="wrapper" style="background: white; margin: 100px auto; padding: 30px; table-layout: fixed;  max-width: 600px;">
		...
		<table class="table table-borderless" style="margin-bottom: 0px !important;">
			<tbody>
				...
				<tr>
					<td>
						<p style="font-size: 26px; font-weight: 600; color: #9bc70a; padding-bottom: 15px;">Your Password is NOT changed !!</p>
					</td>
				</tr>

				<tr>
					<td>
						<p style="font-size: 26px; font-weight: 600; color: #9bc70a; padding-bottom: 15px;">Please
						try again !!</p>
					</td>
				</tr>
