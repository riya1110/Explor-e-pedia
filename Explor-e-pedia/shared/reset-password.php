	...
	<section id="change">
		<div class="container">
				...
				if($_GET['key'] && $_GET['token'])
					{
						...
						$token = $_GET['token'];
							...
							$query = mysqli_query($conn,"SELECT * FROM `user` WHERE `reset_link_token`='".$token."' and `Email_id`='".$email."';");
			...
			?>
						...
						<p class="section-heading" class="text-center">Reset Password</p>
						
						<p class="user-instruction">Enter your email to reset your password</p>
						
						<form action="update-forget-password" method="POST">
						
							<div class="form-group">
								
								<input type="hidden" class="form-control input-box-style" name="email" id="email" value="<?php echo $email;?>" >
								
							</div>

							<div class="form-group">
								
								<input type="hidden" class="form-control input-box-style" name="reset_link_token" id="reset_link_token" value="<?php echo $token;?>" >
							...
							<div class="form-group">
								...
								<input type="password" class="form-control input-box-style" name="cpassword" id="cpassword" placeholder="Confirm your new password" required autocomplete="on">
